...
entry** new_entry(char* path) {
  ...
  /* DANIEL: FAIL - THIS RETURNS NULL FOR SOME REASON. */
  /* That is because it can't make dirs like "mkdir /a/a/c/c/d".
   * That will just fail, this will return NULL and it will SIGSEGV.
   */
